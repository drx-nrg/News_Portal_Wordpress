                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('col-md-8 d-flex flex-column'); ?> itemscope itemtype="https://schema.org/NewsArticle">
                        ...
                        <header class="entry-header">
                            ...
                            <div class="d-flex flex-wrap w-100 fs-6 fs-md-5 text-dark justify-content-center gap-2">
                                ...
                                <div class="post-date p-0 mb-0 d-flex align-items-center">
                                    ...
                                    <i class="bi bi-calendar ms-2 me-2"></i> <time datetime="<?php echo esc_html(wp_date('c', get_post_time('U', true))); ?>" itemprop="datePublished"><?php echo wp_date('l, d M Y H:i', get_post_time('U', true)) ?></time>
                                </div>
                        ...
                        if (has_post_thumbnail()) : ?>
                            <figure class="post-thumbnail mb-3 overflow-hidden rounded-3 d-flex flex-column align-items-center" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                                <?php
                                    the_post_thumbnail('medium', ['itemprop' => 'contentUrl', 'class' => 'rounded-3']);
                                    ...
                                    if (!empty($thumb_description)) : ?>
                                        <figcaption itemprop="caption" class="featured-image-description mt-2 text-center text-secondary">
