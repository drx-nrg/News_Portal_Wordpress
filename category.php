...
<section id="<?= "category" . strtolower(single_term_title()) ?>">
    <header class="header mb-3">
        <h1 class="category-title bg-success text-white fs-5" style="clip-path: polygon(0 0, 90% 0, 100% 100%, 0% 100%); padding: 10px 20px 10px 15px; max-width: fit-content;" itemprop="name"><?php single_term_title(); ?></h1>
        <hr class="green-line">
    </header>
