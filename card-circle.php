<article class="col-md-12 card-secondary d-flex align-items-center text-decoration-none text-dark border-bottom pb-2" style="height: 120px;">
    ...
    <?php endif; ?>
    <div class="col-8 mt-3 mt-md-0 px-4">
        <h1 class="card-title mb-2 fs-6"> <a href="<?php the_permalink() ?>" class="post-title text-dark text-decoration-none"><?= limit_words(get_the_title(), 5) ?></a></h1>
        <div class="d-flex flex-wrap align-items-center mb-2 text-dark">
            <span class="me-3"><?= diffForHumans(strtotime(get_the_date('c'))) ?></span>
        </div>
    </div>
</article>