                        ...
                        <div class="row">
                            ...
                            ?>
                                <div class="col-lg-6">
                                    ...
                                    ?>
                                        <article aria-labelledby="editors-pick-article-heading" itemscope itemtype="https://schema.org/NewsArticle">
                            ...
                            ?>
                                <div class="col-lg-6">
                                    ...
                                    ?>
                                        <article aria-labelledby="warm-topic-article-heading" itemscope itemtype="https://schema.org/NewsArticle">
                                            <?php get_template_part('card', 'secondary', array('mb' => true)) ?>
                                        </article>
                                    <?php endwhile;
                                    wp_reset_postdata();
                                                ...
                                                <?php if (has_post_thumbnail()) : ?>
                                                    <div class="card-img-top rounded-0 h-100 position-relative overflow-hidden">
                                                        ...
                                                        <div class="card-img-overlay position-absolute d-flex flex-column justify-content-end align-items-start p-4 bottom-0">
                                                            ...
                                                            <h2 class="card-title mb-2 fs-4" itemprop="headline"><?php the_title(); ?></h2>
                                                            <div class="d-flex align-items-center mb-2 fs-6">
                                                                <i class="bi bi-person me-2"></i>
                                                                <span class="me-3" itemprop="author">Oleh <?php the_author(); ?></span>
                                                                <i class="bi bi-calendar me-2"></i>
