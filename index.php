...
<main class="container-fluid" itemscope itemtype="http://schema.org/Website">
    ...
    <div class="row gap-5 gap-md-0 <?= get_theme_mod('is_show_headline', true) || get_theme_mod('is_active_slider', true) ? 'mt-5' : ''  ?>">
        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 class="fw-semibold fs-2 mb-3" id="latest-news-heading">
                ...
                <section class="row mt-3" aria-labelledby="category-<?php echo esc_attr($category->slug); ?>-heading">
                    <div class="col-md-12">
                        <div class="row d-flex align-items-center mb-3">
                            <div class="col-md-8">
                                <h2 class="fs-2 fw-semibold" id="category-<?php echo esc_attr($category->slug); ?>-heading"><?= $category->name ?></h2>
